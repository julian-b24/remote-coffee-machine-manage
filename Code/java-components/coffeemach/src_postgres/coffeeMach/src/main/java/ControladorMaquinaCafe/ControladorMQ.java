package controladorMaquinaCafe;
...
public class ControladorMQ implements Runnable, ServicioAbastecimiento{
	...
	private ServicioComMQCafePrx servicioComMQCafe;
	public void setServicioComMQCafe(ServicioComMQCafePrx servicio) {
		servicioComMQCafe = servicio;
	}
    
	private ServicioProxyServerPrx servicioMQProxy;

	public void setServicioMQProxy(ServicioProxyServerPrx serv) {
		servicioMQProxy = serv;
	}
