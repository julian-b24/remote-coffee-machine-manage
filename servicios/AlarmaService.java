...
{
    void recibirNotificacionEscasezIngredientes(String iDing, int idMaq, String uuidACK, ReliableMessageAlarmaServicePrx proxy, com.zeroc.Ice.Current current);

    void recibirNotificacionInsuficienciaMoneda(Moneda moneda, int idMaq, String uuidACK, ReliableMessageAlarmaServicePrx proxy, com.zeroc.Ice.Current current);

    void recibirNotificacionEscasezSuministro(String idSumin, int idMaq, String uuidACK, ReliableMessageAlarmaServicePrx proxy, com.zeroc.Ice.Current current);

    void recibirNotificacionAbastesimiento(int idMaq, String idInsumo, int cantidad, String uuidACK, ReliableMessageAlarmaServicePrx proxy, com.zeroc.Ice.Current current);

    void recibirNotificacionMalFuncionamiento(int idMaq, String descri, String uuidACK, ReliableMessageAlarmaServicePrx proxy, com.zeroc.Ice.Current current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_recibirNotificacionEscasezIngredientes(AlarmaService obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        int iceP_idMaq;
        String iceP_uuidACK;
        ReliableMessageAlarmaServicePrx iceP_proxy;
        iceP_iDing = istr.readString();
        iceP_idMaq = istr.readInt();
        iceP_uuidACK = istr.readString();
        iceP_proxy = ReliableMessageAlarmaServicePrx.uncheckedCast(istr.readProxy());
        inS.endReadParams();
        obj.recibirNotificacionEscasezIngredientes(iceP_iDing, iceP_idMaq, iceP_uuidACK, iceP_proxy, current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_recibirNotificacionInsuficienciaMoneda(AlarmaService obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        iceP_proxy = ReliableMessageAlarmaServicePrx.uncheckedCast(istr.readProxy());
        inS.endReadParams();
        obj.recibirNotificacionInsuficienciaMoneda(iceP_moneda, iceP_idMaq, iceP_uuidACK, iceP_proxy, current);
        return inS.setResult(inS.writeEmptyParams());
    }
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_recibirNotificacionEscasezSuministro(AlarmaService obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        iceP_proxy = ReliableMessageAlarmaServicePrx.uncheckedCast(istr.readProxy());
        inS.endReadParams();
        obj.recibirNotificacionEscasezSuministro(iceP_idSumin, iceP_idMaq, iceP_uuidACK, iceP_proxy, current);
        return inS.setResult(inS.writeEmptyParams());
    }
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_recibirNotificacionAbastesimiento(AlarmaService obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        iceP_proxy = ReliableMessageAlarmaServicePrx.uncheckedCast(istr.readProxy());
        inS.endReadParams();
        obj.recibirNotificacionAbastesimiento(iceP_idMaq, iceP_idInsumo, iceP_cantidad, iceP_uuidACK, iceP_proxy, current);
        return inS.setResult(inS.writeEmptyParams());
    }
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_recibirNotificacionMalFuncionamiento(AlarmaService obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        iceP_proxy = ReliableMessageAlarmaServicePrx.uncheckedCast(istr.readProxy());
        inS.endReadParams();
        obj.recibirNotificacionMalFuncionamiento(iceP_idMaq, iceP_descri, iceP_uuidACK, iceP_proxy, current);
        return inS.setResult(inS.writeEmptyParams());
    }
