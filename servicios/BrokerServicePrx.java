...
{
    default String subscribeServer(AlarmaServicePrx server)
    {
        return subscribeServer(server, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String subscribeServer(AlarmaServicePrx server, java.util.Map<String, String> context)
    {
        return _iceI_subscribeServerAsync(server, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> subscribeServerAsync(AlarmaServicePrx server)
    {
        return _iceI_subscribeServerAsync(server, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> subscribeServerAsync(AlarmaServicePrx server, java.util.Map<String, String> context)
    {
        return _iceI_subscribeServerAsync(server, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_subscribeServerAsync(AlarmaServicePrx iceP_server, java.util.Map<String, String> context, boolean sync)
    {
